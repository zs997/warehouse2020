...
import cn.zs.model.column.ColumnM;
 ...
 **/
public class SolutionM implements  Solution{
    public   void doDP(Answer answer) {
        ...
        HashMap<String, ColumnM> columnMap = new HashMap<>();
        ...
        for (int i = 0; i <= N; i++) {
            ...
            for (int j = 0; j <= N - i; j++) {
                ...
                ColumnM colSymmetry = new ColumnM();
...
//                            }
                            ...
                            ColumnM col0 = columnMap.get(single0);//单个通道的库位分配:库位分配,ELr,enterprob经过了计算
                            ...
                            ColumnM col1 = columnMap.get(single1);//单个通道的库位分配:库位分配,ELr,enterprob经过了计算
